...
import com.example.myclub.adapters.ApproveBookingListAdapter;
...
public class ApproveClubBookings extends Activity implements ClassroomViewFetchMessage {

    private String studentID, studentEmail,studentPassword,studentName, isAdvisor;
    ArrayList<String> clubList;

    private RecyclerView ListDataView;
    private ApproveBookingListAdapter approveBookingListAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        title.setText("Approve Classroom Booking");
    ...
    public void RecyclerViewMethods() {
        ...
        approveBookingListAdapter = new ApproveBookingListAdapter(this, classroomModuleArrayList);
        ListDataView.setAdapter(approveBookingListAdapter);
    ...
    public void onUpdateSuccess(ClassroomModule message) {
        ...
        if(message != null && message.getIsAvailable().equals("Pending")){
        ...
        approveBookingListAdapter.notifyDataSetChanged();
    }

    @Override
    public void onUpdateFailure(String message) {
        Toast.makeText(ApproveClubBookings.this, message, Toast.LENGTH_LONG).show();
    }
    @Override
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(ApproveClubBookings.this, AdminHomeActivity.class);
