...
import com.example.myclub.adapters.MyClubAdapter;
...
public class MyClubActivity extends AppCompatActivity implements ClubViewFetchDataMessage {
    ...
    public void RecyclerViewMethods() {
        ...
        myClubAdapter = new MyClubAdapter(this, clubModuleArrayList,studentID, studentEmail,studentPassword,studentName, isAdvisor, clubList);
        ListDataView.setAdapter(myClubAdapter);
    ...
    public void onUpdateSuccess(ClubModule message) {
        ...
        if(message != null && message.getClubMemberList().contains(studentEmail)){
    ...
    public void onUpdateFailure(String message) {
        ...
        Toast.makeText(MyClubActivity.this, message, Toast.LENGTH_LONG).show();
    }

    @Override
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(MyClubActivity.this, StudentHomeActivity.class);
