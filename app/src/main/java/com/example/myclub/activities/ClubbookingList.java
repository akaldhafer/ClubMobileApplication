...
public class ClubbookingList extends Activity implements ClassroomViewFetchMessage {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        title.setText("Club Booking List");
    ...
    public void onUpdateFailure(String message) {
        Toast.makeText(ClubbookingList.this, message, Toast.LENGTH_LONG).show();
    }
    @Override
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(ClubbookingList.this, AdvisorHomeActivity.class);
